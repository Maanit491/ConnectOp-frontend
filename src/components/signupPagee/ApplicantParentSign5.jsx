...
<div className="row">
    <div className="col-lg-10 mx-auto">
        ...
        <Applicant/>
          ...
          <div className="mt-4 mb-4 sign-choose-content sign-choose-content5" style={{width:"30rem"}}>
         <ChooseContent
         content = {chooseData[5].content}
         />     
         <p style={{marginTop:"-0.7rem"}}>(you can select multiple options)</p>
          </div>
        
<div className="form-check appjourney" style={{width:"313.36",height:"420px",gap:"28px"}}>  
{
  CheckData.map((e)=>{
    return(
      <>
      <div className="inner-appjourney" style={{ marginRight: "1rem",width:"600px"}}>
...
{e.label}
          ...
          <div className="backContButt" style={{marginTop:"-2rem"}}>
