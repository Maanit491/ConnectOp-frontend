...
<div className="row">
    <div className="col-lg-10 mx-auto">
        ...
        <Applicant/>
          <div className="col-lg-5 me-5 col-md-5 col-12 order-2 order-lg-2
            sign-column2 sign-column2-applicant flex-column mb-5" style={{width:"438px",height:"583.65px"}}>
         ...
         <ChooseContent
         content = {chooseData[0].content}
         />
          </div>

          <div className="sign-mobile">
          <MultiOpt
          label = {multiOptdata[0].label}
          multi = {multiOptdata[0].multi}
          dropdownItem = {multiOptdata[0].dropdownItem}
          />

          <div className="sign-mobile">
         
          <label for="exampleInputEmail1" className="form-label mt-3" style={{color:"#323A46"}}>Specialization ( Top 3 preferences )</label>
